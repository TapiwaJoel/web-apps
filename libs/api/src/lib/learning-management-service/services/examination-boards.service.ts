...
export class ExaminationBoardsService {
  ...
  public create(
    ...
    return this.http
      ...
      .pipe(
        map(
          (
            r: ServiceResponse<ExaminationBoardResponseDto>,
          ): ExaminationBoardResponseDto => r.data,
        ),
  ...
  public list(
    ...
    return this.http
      .get<ServiceResponse<PaginateResult<ExaminationBoardResponseDto>>>(
        this.url(),
        {
          params,
        },
