...
export class SystemUsersService {
  ...
  public create(dto: CreateSystemUserDto): Observable<SystemUserResponseDto> {
    return this.http
      .post<ServiceResponse<SystemUserResponseDto>>(this.url(), dto)
      .pipe(
        map(
          (r: ServiceResponse<SystemUserResponseDto>): SystemUserResponseDto =>
            r.data,
        ),
  ...
  public list(
    ...
    return this.http
      .get<ServiceResponse<PaginateResult<SystemUserResponseDto>>>(this.url(), {
        params,
      })
      .pipe(
        map(
