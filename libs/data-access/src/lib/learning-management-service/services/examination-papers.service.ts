...
export class ExaminationPapersService {
  ...
  public create(dto: CreateExaminationPaperDto): Observable<ExaminationPaperResponseDto> {
    return this.http
      .post<ServiceResponse<ExaminationPaperResponseDto>>(this.url(), dto)
      .pipe(
        map((r: ServiceResponse<ExaminationPaperResponseDto>): ExaminationPaperResponseDto => r.data),
  ...
  public list(
    ...
    return this.http
      .get<ServiceResponse<PaginateResult<ExaminationPaperResponseDto>>>(this.url(), {
        params,
      })
      .pipe(
        map(
  ...
  private url(...segments: string[]): string {
    return buildUrl(this.baseUrl, LEARNING_MANAGEMENT_PATH, 'examination-papers', ...segments);
  }
}
