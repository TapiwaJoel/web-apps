...
export class EducationalLevelsService {
  ...
  public create(dto: CreateEducationalLevelDto): Observable<EducationalLevelResponseDto> {
    return this.http
      .post<ServiceResponse<EducationalLevelResponseDto>>(this.url(), dto)
      .pipe(
        map((r: ServiceResponse<EducationalLevelResponseDto>): EducationalLevelResponseDto => r.data),
  ...
  public list(
    ...
    return this.http
      .get<ServiceResponse<PaginateResult<EducationalLevelResponseDto>>>(this.url(), {
        params,
      })
      .pipe(
        map(
  ...
  private url(...segments: string[]): string {
    return buildUrl(this.baseUrl, LEARNING_MANAGEMENT_PATH, 'educational-levels', ...segments);
  }
}
